...
A list of [`Double`](https://docs.oracle.com/en/java/javase/22/docs/api/java.base/java/lang/Double.html) values can use the same `sumOfList()` method. The following code prints `sum = 7.0`:
