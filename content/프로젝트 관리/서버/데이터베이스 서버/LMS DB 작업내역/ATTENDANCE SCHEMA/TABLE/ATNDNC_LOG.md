...
COMMENT ON COLUMN ATTENDANCE.ATNDNC_LOG.EXCUTE_SYSTEM_NM IS '동작시스템명';  
COMMENT ON COLUMN ATTENDANCE.ATNDNC_LOG.EXCUTE_SYSTEM_RELEASE_NM IS '동작시스템릴리즈명';  
COMMENT ON COLUMN ATTENDANCE.ATNDNC_LOG.EXCUTE_SYSTEM_PC_NM IS '동작시스템PC명';
