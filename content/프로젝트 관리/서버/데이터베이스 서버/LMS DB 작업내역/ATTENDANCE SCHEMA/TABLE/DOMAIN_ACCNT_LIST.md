...
(  
    ...
    EXCUTE_SYSTEM_NM VARCHAR(100),
    EXCUTE_SYSTEM_RELEASE_NM VARCHAR(100),
    EXCUTE_SYSTEM_PC_NM VARCHAR(100),
...
COMMENT ON COLUMN ATTENDANCE.DOMAIN_ACCNT_LIST.EXCUTE_SYSTEM_NM IS '동작시스템명';  
COMMENT ON COLUMN ATTENDANCE.DOMAIN_ACCNT_LIST.EXCUTE_SYSTEM_RELEASE_NM IS '동작시스템릴리즈명';  
COMMENT ON COLUMN ATTENDANCE.DOMAIN_ACCNT_LIST.EXCUTE_SYSTEM_PC_NM IS '동작시스템PC명';
